...
https://github.com/DriesVanHool/jenkins-custom-pipeline/blob/main/images/newItem.jpg

Preferably discard your builds. You can choose the maximum amount of builds.
https://github.com/DriesVanHool/jenkins-custom-pipeline/blob/main/images/discardBuilds.jpg

Fill in the url to your repository
https://github.com/DriesVanHool/jenkins-custom-pipeline/blob/main/images/githubURL.png

To schedual your builds use Poll SCM. In the bellow example the trigger is set to every 5 minutes
https://github.com/DriesVanHool/jenkins-custom-pipeline/blob/main/images/pollSCM.jpg

After this set the Pipeline script from SCM
https://github.com/DriesVanHool/jenkins-custom-pipeline/blob/main/images/pipelineDefenition.png
